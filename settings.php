        ...
        <div class="d-flex justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <img src="images/OIP.jfif" class="rounded-circle" alt="profile" width="40" height="40" srcset="">
                </a>
...
<div class=" mx-0" style="height:85vh; background-color:white;">
    ...
    <div class="row mt-0">
        <div class="col-md-7 col-sm-12">
                <div class="border  position-relative bg-dark" style="background-image:url(images/OIP.jfif);height:130px;">
                 <img class="rounded-circle position-absolute" src="images/OIP.jfif" style="height:130px; width: 130px; bottom:-2rem;left:1rem;">
                </div>
                <div class="py-3"></div>
